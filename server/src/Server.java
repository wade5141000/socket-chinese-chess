...
public class Server {
  ...
  public static void main(String args[]) throws IOException {
    ...
    try {
      ...
      while (!c1_say.equalsIgnoreCase("quit") && !c2_say.equalsIgnoreCase("quit")) {
        ...
        target[1] = moves[4];
        if("1".equals(move)){
          moveOrAttack("c1", Integer.parseInt(where[0]), Integer.parseInt(where[1]), Integer.parseInt(target[0]), Integer.parseInt(target[1]));
        }else if("2".equals(move)){
          openChess(Integer.parseInt(where[0]), Integer.parseInt(where[1]));
        }
        c1_out.writeUTF(drawGameBoard());
        ...
        target[1] = moves[4];
        if("1".equals(move)){
          moveOrAttack("c2", Integer.parseInt(where[0]), Integer.parseInt(where[1]), Integer.parseInt(target[0]), Integer.parseInt(target[1]));
        }else if("2".equals(move)){
          openChess(Integer.parseInt(where[0]), Integer.parseInt(where[1]));
        }
        c1_out.writeUTF(drawGameBoard());
  ...
  private static void openChess(int x, int y) {
  ...
  private static void moveOrAttack(String who, int x, int y, int target_x, int target_y){
